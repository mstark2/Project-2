        ...
        <div class="top">
          ...
          <?php
            ...
            if($row[4]){ //Student ID exists
                //Get student name and email by ID
            ...
            //Remove the appointment that the student is enrolled in
