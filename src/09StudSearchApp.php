...
<html lang="en">
  <head>
    ...
    <link rel='stylesheet' type='text/css' href='../css/StudSearchApp.css'/>
  </head>
  <body>
    <div id="login">
      <div id="form">
		...
		<form action="11StudSearchResult.php" method="post" name="SearchApp">
            ...
            <!-- Display possible times to search for -->
